...
const Blog = () => {
    ...
    return (
        <div className="p-6 min-h-screen overflow-hidden">
            ...
            {/* Blog Modal */}
            {showModal && (
                <div className="modal modal-open  text-black flex items-center justify-center">
                    <div className="modal-box relative bg-base-300 max-w-7xl w-full rounded-xl p-8 shadow-lg">
            ...
            {showDeleteModal &&
                <div className="modal modal-open">
                    <div className="modal-box text-white max-w-md">
            ...
            <div className="w-full bg-gray-200 rounded-2xl py-12 px-4 sm:px-8 lg:px-16 h-[600px] overflow-y-auto">
                {/* Header Section */}
