...
const Blog = () => {
    ...
    const handleFaq = () => {
        ...
        setFaqs((prev) => [...prev, { question: faqQuestionInput, answer: faqAnswerInput }]);
        setFaqQuestionInput('')
        setFaqAnswerInput('')
    }
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="grid grid-cols-1 gap-2 mb-2">
                                        ...
                                        <textarea
                                            placeholder="Answer"
                                            rows={3}
                                            className="textarea textarea-bordered bg-slate-700 w-full text-white"
                                            value={faqAnswerInput}
                                            onChange={(e) => setFaqAnswerInput(e.target.value)}
                                        />
                                    </div>
                                    <button onClick={handleFaq} type="button" className="btn btn-sm bg-[#9B2C2C] text-white hover:bg-red-700 mb-2 self-start">
                                        Add FAQ
                                    </button>

                                    <div className="flex flex-col gap-2">
                                        {faqs?.map((item, index) => (
                                            <div key={index} className="bg-gray-200 text-gray-800 px-3 py-2 rounded-lg flex items-start justify-between gap-2">
                                                <div>
